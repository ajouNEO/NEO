...
- Assets: 페이지 속 각각의 레이어와 컴포넌트들에게 디자인이나 코드를 입힐 수 있습니다.
2) 작업 화면
- Pages/Layers/Assets이 보이는 화면입니다.
- 화면 크기에 따른 페이지의 변화를 나눠서 확인해 반응형 디자인을 하기에 용이합니다.
3) 선택 요소의 여러가지 설정
...
- 또한 Actions에서는 자기가 원하는 디자인 요청 사항을 쓰면, AI가 디자인을 구현해 줍니다.
5) 멤버 관리 및 프로젝트 관리
